...
class tag_context_sub_menu_collection final : public RuntimeClass<RuntimeClassFlags<ClassicCom>, IEnumExplorerCommand>
{
public:
    tag_context_sub_menu_collection(const ComPtr<IUnknown> site_of_folder);
