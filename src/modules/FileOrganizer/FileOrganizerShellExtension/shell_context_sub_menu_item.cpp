...
shell_context_sub_menu_item::shell_context_sub_menu_item(const ComPtr<IUnknown> site_of_folder)
{
    this->site_of_folder = site_of_folder;
}

IFACEMETHODIMP shell_context_sub_menu_item::GetTitle(_In_opt_ IShellItemArray* items, _Outptr_result_nullonfailure_ PWSTR* returned_title)
{
    std::wstring tag1 = L"Common tag 1";

    return SHStrDup(tag1.c_str(), returned_title);
}

IFACEMETHODIMP shell_context_sub_menu_item::GetIcon(_In_opt_ IShellItemArray*, _Outptr_result_nullonfailure_ PWSTR* returned_icon)
{
...
IFACEMETHODIMP shell_context_sub_menu_item::GetToolTip(_In_opt_ IShellItemArray*, _Outptr_result_nullonfailure_ PWSTR* returned_info_tip)
{
