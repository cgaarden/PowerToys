...
#define FILE_ORGANIZER_SHELL_EXTENSION_EXPLORER_COMMAND_UUID_STR "A2877438-9A16-4629-912A-1223B4E3B025"

// File Explorer context menu "Tag"
class __declspec(uuid(FILE_ORGANIZER_SHELL_EXTENSION_EXPLORER_COMMAND_UUID_STR)) shell_context_menu final :
    public RuntimeClass<
