...
void FileOrganizerSettings::RefreshEnabledState()
{
    ...
    try
    {
        ...
        json::get(powertoy_file_organizer_enabled_state, file_organizer::constants::non_localizable::powertoy_key, file_organizer_settings.enabled, false);
    }
...
{
    // Load json settings from data file, if it was modified since we last checked.
...
{
    auto gpoSetting = powertoys_gpo::getConfiguredFileOrganizerEnabledValue();
