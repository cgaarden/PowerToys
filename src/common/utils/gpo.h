...
namespace powertoys_gpo
{
    ...
    const std::wstring POLICY_CONFIGURE_ENABLED_FILE_ORGANIZER = L"ConfigureEnabledUtilityFileOrganizer";
...
#pragma region UtilityEnabledStatePolicies
    ...
    inline gpo_rule_configured_t getConfiguredFileOrganizerEnabledValue()
    {
        return getUtilityEnabledValue(POLICY_CONFIGURE_ENABLED_FILE_ORGANIZER);
    }
